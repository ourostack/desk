...
- **Only the V2 plugins.** Work Suite, Ponytail, the loose skill catalog and their checks stay in `ourostack/ouroboros-skills`. CI now also runs the browser context broker's own tests.
