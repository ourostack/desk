...
const expectedPluginVersion = "3.2.0-alpha.7"
const expectedMcpVersion = "1.4.0-alpha.6"
const expectedReleaseDate = "2026-09-21"
...
test("Desk 3.2.0-alpha.7 and MCP 1.4.0-alpha.6 candidate surfaces move together", async () => {
  const errors = []
