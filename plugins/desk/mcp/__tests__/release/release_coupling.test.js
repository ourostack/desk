...
const expectedPluginVersion = "3.2.0-alpha.11"
const expectedMcpVersion = "1.4.0-alpha.6"
const expectedReleaseDate = "2026-09-24"
...
test("Desk 3.2.0-alpha.11 and MCP 1.4.0-alpha.6 candidate surfaces move together", async () => {
  const errors = []
