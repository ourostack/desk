  ...
  try {
    ...
    const result = await runCodexCliActivationSmoke({
      ...
      codexRunner: async (request) => {
        ...
        assert.match(generatedConfig, /# BEGIN desk activation: desk@1\.8\.0 mode=global-personal owner=desk-activation/u)
        ...
        assert.match(generatedInstructions, /# BEGIN desk activation: desk@1\.8\.0 mode=global-personal owner=desk-activation/u)
