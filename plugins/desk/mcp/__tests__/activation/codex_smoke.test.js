  ...
  try {
    ...
    const result = await runCodexCliActivationSmoke({
      ...
      codexRunner: async (request) => {
        ...
        assert.match(generatedConfig, /# BEGIN desk activation: desk@1\.7\.17 mode=global-personal owner=desk-activation/u)
        ...
        assert.match(generatedInstructions, /# BEGIN desk activation: desk@1\.7\.17 mode=global-personal owner=desk-activation/u)
