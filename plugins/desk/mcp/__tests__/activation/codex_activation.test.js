...
test("Codex activation preserves user-authored config and instructions with owned generated blocks", async () => {
  ...
  assert.match(result.generatedConfig, /# BEGIN desk activation: desk@2\.0\.0 mode=global-personal owner=desk-activation/)
  ...
  assert.match(result.generatedInstructions, /# BEGIN desk activation: desk@2\.0\.0 mode=global-personal owner=desk-activation/)
